...
- **C.1 Exact prompts:** The system and user messages were generated from the supplied QSF by the frozen SurveyTwin pipeline. The public repository includes the QSF and prompt-construction code, while the restricted escrow preserves the adopted provider responses and supporting reconstruction evidence. Prompts were not revised in response to benchmark predictions.
